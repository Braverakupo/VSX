...
import { heroRegistry, gameState, getHeroGemBonuses, getEffectiveStats, formatNotation, getHPGradientColor, getEquippedCount, tapObjective, upgrade, rebirthObjective, isCinematicActive, getOvercoreDmgMult, CHAR_GEM_COLOR, ALL_GEMS, HP_TICK_COUNT } from '../composables/useGameState.js'
...
const props = defineProps({
  ...
  closeDropdownsKey: { type: Number, default: 0 }
})
