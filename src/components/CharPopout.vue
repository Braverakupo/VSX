...
import { heroRegistry, gameState, closeCharPopout, togglePreferredStat, getEffectiveStats, getSpectraGemStatBonus, getHeroGemBonuses } from '../composables/useGameState.js'
...
const totalGemBonuses = computed(() => {
