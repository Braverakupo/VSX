...
import { videoEnabled, toggleVideo, reduceDmgNumbers, toggleReduceDmg } from '../composables/useVideoPool.js'
...
function confirmReset() {
  ...
  window.removeEventListener('beforeunload', window._vantageBeforeUnload)
