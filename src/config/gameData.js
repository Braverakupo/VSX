...
export const STAT_NAMES = ['Str', 'Spi', 'Int', 'Con', 'Dex']
...
export const HP_GRADIENT_ANCHORS = [
...
export const charTemplates = ['Voltkin', 'Ashbeam', 'Crypsis', 'Spectra', 'Hellshift', 'Kailin']
...
export const classDefinitions = [
  ...
  // -
  { id: 'vanguard',      scalingStat: 'Str', name: "Vanguard",     description: "Spearhead of the assault. Vantage builds faster and army swells with each blow.",       vantagePerTap: 1,   armyPerSecond: 2,   flatStats: { Str: 1, Con: 1 },   weight: 100, critDamage: 0.05,  doubleCrit: 0.15 },
  { id: 'berserker',     scalingStat: 'Str', name: "Berserker",    description: "Unleashes raw fury. Devastating crits when vantage peaks.",                          critChance: 0.05,   vantage99DmgMult: 1.5,   flatStats: { Str: 2 },            weight: 90,  critDamage: 0.10,  doubleCrit: 0.15 },
  { id: 'pyromancer',    scalingStat: 'Int', name: "Pyromancer",   description: "Burns through enemy ranks with relentless army pressure and vantage fuels the flames.", armyPerSecond: 2,  vantagePerTap: 1,   flatStats: { Int: 1, Spi: 1 },    weight: 85,  critDamage: 0.0,   doubleCrit: 0.15 },
  { id: 'blademaster',   scalingStat: 'Dex', name: "Blademaster",  description: "Precision and speed. Gains vantage rapidly and strikes true.",                       vantageAutoRate: 0.5, vantagePerTap: 1,   flatStats: { Dex: 2 },            weight: 80,  critDamage: 0.06,  doubleCrit: 0.15 },
  { id: 'warlord',       scalingStat: 'Con', name: "Warlord",      description: "Commands armies from the front. Starts strong and grows faster.",                    armyPerSecond: 2,   flatStats: { Str: 1, Con: 1 },    weight: 75,  critDamage: 0.04,  doubleCrit: 0.15 },
  { id: 'ravager',       scalingStat: 'Str', name: "Ravager",      description: "Relentless aggression. High crit rate that devastates at max vantage.",              critChance: 0.08,   vantage99DmgMult: 2.0,   flatStats: { Str: 2, Dex: 1 },    weight: 70,  critDamage: 0.12,  doubleCrit: 0.15 },
  { id: 'fury',          scalingStat: 'Str', name: "Fury",         description: "Boundless rage breaks the vantage cap. Every tap fuels the fire.",                   vantagePerTap: 2,   flatStats: { Str: 2 },            weight: 65,  critDamage: 0.0,   doubleCrit: 0.15 },
  { id: 'inferno',       scalingStat: 'Int', name: "Inferno",      description: "Scorched-earth tactics. Armies surge as crits blaze through the ranks.",               critChance: 0.04,   armyPerSecond: 2,   flatStats: { Int: 2, Str: 1 },   weight: 60,  critDamage: 0.08,  doubleCrit: 0.15 },
  { id: 'tempest',       scalingStat: 'Dex', name: "Tempest",      description: "A storm of strikes. Vantage builds on its own and crits cut deep.",                  vantageAutoRate: 1.0, critChance: 0.05,   flatStats: { Dex: 2, Spi: 1 },   weight: 55,  critDamage: 0.05,  doubleCrit: 0.15 },
  { id: 'onslaught',     scalingStat: 'Str', name: "Onslaught",    description: "The final charge. Maximum vantage devastation with overwhelming armies.",            vantage99DmgMult: 3.0, armyPerSecond: 2,  flatStats: { Str: 3 },            weight: 50,  critDamage: 0.0,   doubleCrit: 0.15 },
  ...
  { id: 'aegis',         scalingStat: 'Int', name: "Aegis",        description: "Radiant power. Exceptional stat growth per completion and accelerated XP.",           statPerCompletion: 0.04,   flatStats: { Int: 2, Spi: 2 },   weight: 70 },
  ...
  { id: 'ragnarok',      scalingStat: 'Str', name: "Ragnarok",     description: "Battles rage eternal. Accelerated vantage generation.",                                 vantageAutoRate: 1.0,  flatStats: { Str: 2, Con: 1 },   weight: 55 },
 ...
 * Standard buffs (slots 2-6) — any can roll, values scale with tier.
 * Legendary (vantageCapBoost, statPerCompletion) — 5% each, 7th slot only.
 */
export const GEM_MODIFIER_DEFS = {
  damageMult: {
    label: 'Final Dmg',
    base: 0.015,
    perTier: 0.01,
...
/** List of standard (non-legendary) buff types that can roll in slots 2-6. */
export const STANDARD_BUFF_TYPES = [
  'damageMult',
  'vantageAutoRate',
  'armyPerSecond',
  'critDamage',
