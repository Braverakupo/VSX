...
import { initVideoSystem, cleanupVideoSystem, updateVideoForObjective, videoEnabled, toggleVideo } from './composables/useVideoPool.js'
import { heroThemes } from './config/gameData.js'
import GameCard from './components/GameCard.vue'
import CharPopout from './components/CharPopout.vue'
...
function dispatchHover(x, y) {
  ...
  if (lastHoveredEl) {
    lastHoveredEl.dispatchEvent(new MouseEvent('mouseleave', { bubbles: true, clientX: x, clientY: y }))
  }
  lastHoveredEl = el
  // Enter new element
  if (el) {
  ...
  <div id="game-view" data-dev-label="Game View">
    ...
    <div class="header">
      <div class="header-left">
        <div class="title" :style="{ color: titleTheme.color }">VANTAGE STRIKE</div>
        <GemRotary @char-change="selectedGemColor = $event" />
      </div>
      <div class="header-right">
        <div class="header-stat gold-stat">
          ...
          <span class="label rate-label">/S</span>
    ...
    <!-- Char Popout -->
    <CharPopout
      v-if="gameState.popoutHero"
      :hero-name="gameState.popoutHero"
    />
