...
import { heroRegistry, gameState, getHeroGemBonuses, getEffectiveStats, formatNotation, getHPGradientColor, getEquippedCount, tapObjective, upgrade, rebirthObjective, openCharPopout, isCinematicActive, getOvercoreDmgMult, CHAR_GEM_COLOR, ALL_GEMS, HP_TICK_COUNT } from '../composables/useGameState.js'
import { registerCanvas, unregisterCanvas } from '../composables/useVideoPool.js'
import { heroThemes, gemColorInfo } from '../config/gameData.js'
...
const emit = defineEmits(['tapPopup', 'levelUp', 'statPoint', 'gemAward'])
...
const hpVisualizerRef = ref(null)
...
// Open full CharPopout overlay (called from StatSlidePanel's "Full Details" button)
function handleOpenDetails() {
  openCharPopout(props.objective.name)
}
